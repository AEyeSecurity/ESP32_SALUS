...
constexpr float SPEED_PID_THROTTLE_BASE_PID_DELTA_UP_MAX_PERCENT = 100.0f;
...
constexpr float SPEED_PID_STALL_ASSIST_THROTTLE_PERCENT = 90.0f;
constexpr uint16_t SPEED_PID_STALL_ASSIST_WINDOW_MS = 1200;
...
static QuadDriveTaskConfig g_driveTaskConfig = {
    ...
    },
    {
        ...
        SPEED_PID_STALL_ASSIST_THROTTLE_PERCENT,
        SPEED_PID_STALL_ASSIST_WINDOW_MS,
